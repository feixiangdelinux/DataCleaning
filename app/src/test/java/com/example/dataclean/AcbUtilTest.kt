...
class AcbUtilTest {
    ...
    fun cleaningData() {
        ...
        //1加载json文件到内存中
        val fileStr = KtStringUtil.getStrInFile("/home/ccg/acb.json")
//        val fileStr = KtStringUtil.getStrInFile("E:\\acb.json")
        //2把json转换成list
        ...
        KtStringUtil.saveAsFileWriter("/home/ccg/acb1.json", GsonBuilder().create().toJson(list))
//        KtStringUtil.saveAsFileWriter("E:\\acb1.json", GsonBuilder().create().toJson(list))
    ...
    fun cleaningDataTwo() {
        //1加载json文件到内存中
        val fileStr = KtStringUtil.getStrInFile("/home/ccg/acb1.json")
//        val fileStr = KtStringUtil.getStrInFile("E:\\acb1.json")
        val fileStrTwo = KtStringUtil.getStrInFile("/home/ccg/acbText.json")
//        val fileStrTwo = KtStringUtil.getStrInFile("E:\\acbText.json")
//        //2把json转换成list
        ...
        KtStringUtil.saveAsFileWriter("/home/ccg/acbok.json", GsonBuilder().create().toJson(listDatasOne))
...
//        )
    ...
    fun cleaningDataThree() {
        //1加载json文件到内存中
        val fileStr = KtStringUtil.getStrInFile("/home/ccg/acbok.json")
//        val fileStr = KtStringUtil.getStrInFile("E:\\acbok.json")
...
//            val videoU = "E:\\新建文件夹\\$i.json"
            ...
            videoUrl.add("https://siyou.nos-eastchina1.126.net/21/acb/$i.json")
        }
